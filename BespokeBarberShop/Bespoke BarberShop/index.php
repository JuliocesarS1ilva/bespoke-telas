...
<body>
  ...
  <nav class="navbar sticky-top navbar-expand-lg" style="background-color: black;">
    <div class="container-fluid">
      ...
      <div class="offcanvas offcanvas-end" style="background-color: black;" tabindex="-1" id="offcanvasNavbar"
  ...
  <div class="container py-5" id="SobreNos"
    style="background-image: url('imagens/image 1.png'); background-size: cover; background-position: center; background-repeat: no-repeat;">
  ...
  <!-- Seção "Como é o nosso espaço" -->
  <div class="container py-5" id="Espaco"
    style="background-image: url('imagens/image 3.png'); background-size: cover; background-position: center; background-repeat: no-repeat;">
    <div class="row align-items-center justify-content-center g-5 flex-lg-row flex-column-reverse">
      ...
      <div class="col-12 col-lg-6">
        <div class="row g-4">
          <div class="col-6">
            <div class="p-4 rounded-4 shadow-lg h-100 espaco-card"
  ...
  <!-- Script do efeito hover -->
  <script>
    document.querySelectorAll('.espaco-card').forEach(card => {
      const icon = card.querySelector('i');

      card.addEventListener('mouseenter', () => {
        card.classList.add('shadow-lg', 'border-warning', 'scale-up');
      ...
      card.addEventListener('mouseleave', () => {
        card.classList.remove('border-warning', 'scale-up');
        card.style.backgroundColor = 'rgba(20,20,20,0.7)';
        card.style.transform = 'translateY(0)';
        if (icon) icon.style.color = '#daa520';
      });
    });
  </script>
